...
def get_region_boxes(output, conf_thresh, num_classes, anchors, num_anchors, only_objectness = 1, validation = False):
    ...
    output1 = output.view(batch * num_anchors, 5 + num_classes, h * w).transpose(0, 1)
    # print("output1.shape:",output1.shape)
    # print("output1[0][1][1]:",output1[0][1][1])
    output=output1.contiguous().view(5+num_classes, batch*num_anchors*h*w)
    ...
    # print("output.shape:",output.shape)
    # print("det_confs.shape",det_confs.shape)
    boxes=[]
